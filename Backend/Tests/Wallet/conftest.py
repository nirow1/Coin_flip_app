...
from Backend.Wallet.models import Wallet, UserSolanaWallet
...
import Backend.Notification.models  # noqa: F401  (Notification, relationship on User)
import Backend.Social.models  # noqa: F401  (Friend, relationship on User)
import Backend.Leader_board.model  # noqa: F401  (Leaderboard, relationship on User)
import Backend.Game.models  # noqa: F401  (any Game models referencing Base)
import pytest
